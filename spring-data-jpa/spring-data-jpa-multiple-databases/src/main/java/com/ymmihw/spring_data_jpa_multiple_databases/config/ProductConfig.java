...
@EnableJpaRepositories(
    basePackages = "com.ymmihw.spring_data_jpa_multiple_databases.persistence.dao.product",
...
public class ProductConfig {
  ...
  public LocalContainerEntityManagerFactoryBean productEntityManager() {
    ...
    em.setPackagesToScan(
        new String[] {"com.ymmihw.spring_data_jpa_multiple_databases.persistence.model.product"});
